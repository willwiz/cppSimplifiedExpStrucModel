//
//  CollagenConstitutiveModels.hpp
...
#ifndef CollagenConstitutiveModels_hpp
#define CollagenConstitutiveModels_hpp
...
private:
    double m_1_lf; // 1/lambda_fiber
    
    
public:
    col_f_PF():m_1_lf(1.0){};
    
    col_f_PF(double lf):m_1_lf(1.0/lf){
    }
...
#endif /* CollagenConstitutiveModels_hpp */
